...
const CommandPalette: React.FC = () => {
  ...
  const commands = useMemo((): Command[] => {
    ...
    return [
      ...
      { id: 'moveUp', label: 'Move Terminal Up', shortcut: 'Ctrl+Alt+\u2191', action: () => { const id = focusedId(); if (id) store().moveTerminalDirection(id, 'up'); } },
      { id: 'moveDown', label: 'Move Terminal Down', shortcut: 'Ctrl+Alt+\u2193', action: () => { const id = focusedId(); if (id) store().moveTerminalDirection(id, 'down'); } },
      { id: 'moveLeft', label: 'Move Terminal Left', shortcut: 'Ctrl+Alt+\u2190', action: () => { const id = focusedId(); if (id) store().moveTerminalDirection(id, 'left'); } },
      { id: 'moveRight', label: 'Move Terminal Right', shortcut: 'Ctrl+Alt+\u2192', action: () => { const id = focusedId(); if (id) store().moveTerminalDirection(id, 'right'); } },
